...
> **As of 2026-07-06:** open upstream PRs — WhatsApp owner-forward stack ([#16445](https://github.com/NousResearch/hermes-agent/pull/16445) → … → busy-path PR) via `fix/busy-path-pre-gateway-dispatch-upstream`, [#18413](https://github.com/NousResearch/hermes-agent/pull/18413) (OpenCode auxiliary `/v1`) via `fix/auxiliary-opencode-strip-trailing-v1`, [#20713](https://github.com/NousResearch/hermes-agent/pull/20713) (end-turn tool contract) via `feature/end-turn-tool-contract-upstream`, [#24853](https://github.com/NousResearch/hermes-agent/pull/24853) (diagnostic status gate) via `fix/diagnostic-status-leak-and-end-turn-nudge`, [#25119](https://github.com/NousResearch/hermes-agent/pull/25119) (queued follow-up media delivery) via `fix/queued-followup-media-delivery-upstream`, and [#53544](https://github.com/NousResearch/hermes-agent/pull/53544) (undelivered tool-call content) via `fix/undelivered-tool-call-content`. [#20747](https://github.com/NousResearch/hermes-agent/pull/20747) closed (superseded by upstream `c75e1a03f` / #21454); [#25183](https://github.com/NousResearch/hermes-agent/pull/25183) absorbed upstream as `9a815b6c8`; [#17165](https://github.com/NousResearch/hermes-agent/pull/17165) closed (text debounce superseded upstream as `b0ce47daa` / `cddb7283d`); [#53038](https://github.com/NousResearch/hermes-agent/pull/53038) closed (STT echo toggle superseded upstream as `bfc526272` / `4be749d15` with `stt.echo_transcripts`) — all four fork branches dropped from `FEATURE_BRANCHES`. Otherwise `main = upstream/main + ops-overlay + cherry-picked feature branches`.
