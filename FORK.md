...
> **As of 2026-05-14:** open upstream PRs — WhatsApp owner-forward stack ([#16445](https://github.com/NousResearch/hermes-agent/pull/16445) → … → busy-path PR) via `fix/busy-path-pre-gateway-dispatch-upstream`, [#17165](https://github.com/NousResearch/hermes-agent/pull/17165) (WhatsApp inbound text batching) via `feature/whatsapp-inbound-text-batch`, [#18413](https://github.com/NousResearch/hermes-agent/pull/18413) (OpenCode auxiliary `/v1`) via `fix/auxiliary-opencode-strip-trailing-v1`, [#20713](https://github.com/NousResearch/hermes-agent/pull/20713) (end-turn tool contract) via `feature/end-turn-tool-contract-upstream`, [#20747](https://github.com/NousResearch/hermes-agent/pull/20747) (launcher symlink clobber) via `fix/launcher-symlink-clobber-upstream`, diagnostic-status leak + end-turn nudge correction via `fix/diagnostic-status-leak-and-end-turn-nudge`, [#25119](https://github.com/NousResearch/hermes-agent/pull/25119) (queued follow-up media delivery) via `fix/queued-followup-media-delivery-upstream`, and [#25183](https://github.com/NousResearch/hermes-agent/pull/25183) (queued follow-up transcript history) via `fix/queued-followup-history-persistence-upstream`. Drop each branch from `FEATURE_BRANCHES` once merged. Otherwise `main = upstream/main + ops-overlay + cherry-picked feature branches`.
...
| [NousResearch/hermes-agent#25183](https://github.com/NousResearch/hermes-agent/pull/25183) | `fix/queued-followup-history-persistence-upstream` | **Open.** Preserve queued follow-up transcript history by carrying the outer history offset through recursive drain chains. |
